...
export const stages: StageDef[] = [
  ...
  },
  {
    ...
    entities: [
      ...
      // Blue lane deflectors
      {
        type: 'static',
        position: { x: 13.1, y: 31 },
        shape: {
          type: 'box',
          width: 2.7,
          height: 0.18,
      ...
      // Star clusters
      {
        ...
        props: { density: 1, angularVelocity: 0, restitution: 1.35 },
      },
      {
        type: 'static',
        position: { x: 7.1, y: 26.9 },
        shape: {
          type: 'box',
          width: 0.45,
          height: 0.12,
      ...
      // Rejoin and final goal funnel
      {
        type: 'static',
        position: { x: 12.2, y: 78.5 },
        shape: {
          type: 'box',
          width: 1.6,
          height: 0.18,
      ...
      },
      {
        ...
        props: { density: 1, angularVelocity: 1.1, restitution: 0 },
      },
    ],
  },
];
