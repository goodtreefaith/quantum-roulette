...
export const stages: StageDef[] = [
  ...
  },
  {
    ...
    entities: [
      ...
      // Sun cluster near the top-middle
      {
        type: 'static',
        position: { x: 13, y: 46.5 },
        shape: {
          type: 'circle',
          radius: 0.42,
          color: '#fcd116',
      ...
      // Three star accents near safe transition points
      {
        type: 'static',
        position: { x: 10.4, y: 33.8 },
        shape: {
          type: 'circle',
          radius: 0.26,
          color: '#fcd116',
